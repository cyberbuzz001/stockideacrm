...
deploy_vps.sh - Automatic deployment script.
docker-compose.yml - Docker configuration containerizing PHP, Nginx, Node.js, and Redis.
.env.evolution - Reference configuration containing all environment variables including Meta Cloud credentials.
